...
<body class="w3-grey">
    <div class="w3-container w3-center w3-padding-large w3-cyan w3-text-white" style="position: fixed; z-index: 9999; width: 100%;">
        @guest
            <span class="w3-large w3-wide">Twitter Application</span>
        @else
            <div class="w3-dropdown-hover w3-transparent">
                <a class="w3-large w3-wide w3-text-white w3-hover-text-light-gray text-no-decoration" href="#">Twitter Application</a>
